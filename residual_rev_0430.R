...
# library(JGmisc)
# detachAllPackages(keep = NULL, unload = TRUE, force = FALSE)
...
# Load historical data
#****************************************************************** 
# unload tidyverse because it will conflict with SIT package
load.packages('pacman')
library(pacman)
p_unload(tidyverse, negate = TRUE)
load.packages('quantmod') 
#
library(pacman)
p_load(PerformanceAnalytics, lubridate, reshape2, psych, fBasics, Hmisc, xts)
